...
pub trait Service {
    ...
    /// standard library.
    fn map<F, R>(self, f: F) -> crate::service::dev::Map<Self, F, R>
    where
        Self: Sized,
        F: FnMut(Self::Response) -> R,
    {
        crate::service::dev::Map::new(self, f)
    }
    ...
    fn map_err<F, E>(self, f: F) -> crate::service::dev::MapErr<Self, F, E>
    where
        Self: Sized,
        F: Fn(Self::Error) -> E,
    {
        crate::service::dev::MapErr::new(self, f)
    }
}
...
pub trait ServiceFactory {
    ...
    /// Map this service's output to a different type, returning a new service
    /// of the resulting type.
    fn map<F, R>(self, f: F) -> crate::service::map::MapServiceFactory<Self, F, R>
    where
        Self: Sized,
        F: FnMut(Self::Response) -> R + Clone,
    {
        crate::service::map::MapServiceFactory::new(self, f)
    }

    /// Map this service's error to a different error, returning a new service.
    fn map_err<F, E>(self, f: F) -> crate::service::map_err::MapErrServiceFactory<Self, F, E>
    where
        Self: Sized,
        F: Fn(Self::Error) -> E + Clone,
    {
        crate::service::map_err::MapErrServiceFactory::new(self, f)
    }

    /// Map this factory's init error to a different error, returning a new service.
    fn map_init_err<F, E>(self, f: F) -> crate::service::map_init_err::MapInitErr<Self, F, E>
    where
        Self: Sized,
        F: Fn(Self::InitError) -> E + Clone,
    {
        crate::service::map_init_err::MapInitErr::new(self, f)
    }
}
...
pub mod dev {
    pub use crate::service::and_then::{AndThenService, AndThenServiceFactory};
    pub use crate::service::and_then_apply_fn::{AndThenApplyFn, AndThenApplyFnFactory};
    pub use crate::service::apply::{Apply, ApplyServiceFactory};
    pub use crate::service::apply_cfg::{ApplyConfigService, ApplyConfigServiceFactory};
    pub use crate::service::fn_service::{
        FnService, FnServiceConfig, FnServiceFactory, FnServiceNoConfig,
    };
    pub use crate::service::map::{Map, MapServiceFactory};
    pub use crate::service::map_config::{MapConfig, UnitConfig};
    pub use crate::service::map_err::{MapErr, MapErrServiceFactory};
    pub use crate::service::map_init_err::MapInitErr;
    pub use crate::service::then::{ThenService, ThenServiceFactory};
    pub use crate::service::transform::ApplyTransform;
    pub use crate::service::transform_err::TransformMapInitErr;
}