use crate::krse::io::util::chain::{chain, Chain};
use crate::krse::io::util::read::{read, Read};
use crate::krse::io::util::read_buf::{read_buf, ReadBuf};
use crate::krse::io::util::read_exact::{read_exact, ReadExact};
use crate::krse::io::util::read_int::{ReadU8, ReadU16, ReadU32, ReadU64, ReadU128};
use crate::krse::io::util::read_int::{ReadI8, ReadI16, ReadI32, ReadI64, ReadI128};
use crate::krse::io::util::read_to_end::{read_to_end, ReadToEnd};
use crate::krse::io::util::read_to_string::{read_to_string, ReadToString};
use crate::krse::io::util::take::{take, Take};
use crate::krse::io::AsyncRead;
...
use bytes::BufMut;
    ...
    /// ```
    ///
    /// See [module][crate::krse::io] documentation for more details.
    ///
    /// [`AsyncRead`]: AsyncRead
    ...
    pub trait AsyncReadExt: AsyncRead {
        ...
        /// ```
        ///
        /// (See also the [`kayrx::krse::fs::read`] convenience function for reading from a
        /// file.)
        ///
        /// [`kayrx::krse::fs::read`]: crate::fs::read::read
