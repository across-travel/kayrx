    ...
    >,
{
    ...
    ///
    /// ```rust
    /// use kayrx::web::{self, types, guard, App, HttpResponse};
    ///
    ...
    ///     );
    /// }
    /// # async fn get_handler() -> impl kayrx::web::Responder { kayrx::web::HttpResponse::Ok() }
    /// # async fn post_handler() -> impl kayrx::web::Responder { kayrx::web::HttpResponse::Ok() }
    /// # async fn delete_handler() -> impl kayrx::web::Responder { kayrx::web::HttpResponse::Ok() }
    /// ```
    ...
    ///
    /// ```rust
    /// use kayrx::web::{self, HttpRequest, HttpResponse, App};
    ///
...
//     use crate::web::{guard, self, App, Error, HttpResponse};
