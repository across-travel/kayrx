...
impl<T: str::FromStr> str::FromStr for QualityItem<T> {
    ...
    fn from_str(s: &str) -> Result<QualityItem<T>, crate::http::error::ParseError> {
        if !s.is_ascii() {
        ...
        if parts.len() == 2 {
            ...
            if start == "q=" || start == "Q=" {
                ...
                match q_part.parse::<f32>() {
                    ...
                    Err(_) => return Err(crate::http::error::ParseError::Header),
                }
            }
        }
        match raw_item.parse::<T>() {
            ...
            Err(_) => Err(crate::http::error::ParseError::Header),
        }
    }
}
