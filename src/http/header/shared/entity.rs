...
use crate::http::header::{HeaderValue, IntoHeaderValue, InvalidHeaderValue, Writer};
...
impl FromStr for EntityTag {
    type Err = crate::http::error::ParseError;

    fn from_str(s: &str) -> Result<EntityTag, crate::http::error::ParseError> {
