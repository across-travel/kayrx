use crate::http::h2::codec::RecvError;
use crate::http::h2::error::Reason;
use crate::http::h2::frame::{Pseudo, StreamId};
use crate::http::h2::proto::Open;
...
impl Dyn {
    ...
    pub fn convert_poll_message(
        ...
        if self.is_server() {
            crate::http::h2::server::Peer::convert_poll_message(pseudo, fields, stream_id)
                .map(PollMessage::Server)
        } else {
            crate::http::h2::client::Peer::convert_poll_message(pseudo, fields, stream_id)
