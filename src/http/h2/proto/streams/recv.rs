...
use crate::http::h2::frame::{PushPromiseHeaderError, Reason, DEFAULT_INITIAL_WINDOW_SIZE};
use crate::http::h2::{frame, proto};
...
impl Recv {
    ...
    pub fn recv_push_promise(
        ...
        let (pseudo, fields) = frame.into_parts();
        let req = crate::http::h2::server::Peer::convert_poll_message(pseudo, fields, promised_id)?;
